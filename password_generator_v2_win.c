...
system("cls");
  ...
  printf("How many characters should your password be?\n\n");
  ...
  while(input!=13) // si on appui par sur la touch entrer
  {
    ...
    printf("Choose a type of password:\n\n");
    ...
    {
      printf("1.With capital letters\n");
      printf("2.With lowercase letters\n");
      printf("3.With numbers\n");
      printf("4.With special characters\n");
      m=0;
    }
    ...
    printf("\n\nUse numbers 1 through 4 on your keyboard to select parameters\n");
